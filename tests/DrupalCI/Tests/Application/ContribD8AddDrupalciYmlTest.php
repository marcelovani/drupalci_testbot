 ...
 * @see TESTING.md
 */
class ContribD8AddDrupalciYmlTest extends DrupalCIFunctionalTestBase {

  public function testAddsDrupalCi() {
    $options = ['interactive' => FALSE];
    $this->app_tester->run([
      'command' => 'run',
      'definition' => 'tests/DrupalCI/Tests/Application/Fixtures/build.ContribD8AddDrupalciYmlTest.yml',
    ], $options);

    // Make sure we did all the things we want.
    $this->assertRegExp('/2952984_2_add_drupalciyml.patch/', $this->app_tester->getDisplay());
