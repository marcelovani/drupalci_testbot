 ...
 * @see TESTING.md
 */
class ContribD8SniffPatchedTest extends DrupalCIFunctionalTestBase {
  ...
  public function testD8Contrib() {
    ...
    $app_tester->run([
      'command' => 'run',
      'definition' => 'tests/DrupalCI/Tests/Application/Fixtures/build.ContribD8SniffPatched.yml',
    ], $options);
